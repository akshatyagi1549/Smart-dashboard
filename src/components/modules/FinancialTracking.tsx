...
export function FinancialTracking() {
  ...
  // Load user selections for Financial Tracking features
  useEffect(() => {
    const storedAnswers = localStorage.getItem("userAnswers");
    if (storedAnswers) {
      const parsed = JSON.parse(storedAnswers);
      if (parsed.financialTrackingFeatures) {
        setSelectedFeatures(parsed.financialTrackingFeatures);
      }
    }
  }, []);
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          ...
          {selectedFeatures.includes('Add Expense') && (
      ...
      {/* Stats Section */}
      {selectedFeatures.includes('Recent Transactions') && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          {/* Expense Categories */}
          {selectedFeatures.includes('Expense Categories') && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
              <div className="p-6 border-b border-gray-100">
                ...
                {expenseCategories.map((category, index) => (
                  <div key={index}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className={`${category.color} h-2 rounded-full transition-all duration-300`} style={{ width: `${category.percentage}%` }}/>
                    </div>
          ...
          {/* Financial Health */}
          {selectedFeatures.includes('Financial Health') && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
              <div className="p-6 border-b border-gray-100">
