...
export function JoinPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.organization.trim()) {
      newErrors.organization = 'Organization (NGO Name) is required';
    }
  ...
  // Mapping frontend roles to backend roles
  const mapRoleToBackend = (role: 'staff' | 'leadership' | 'employee'): 'director' | 'executive' | 'employee' => {
    if (role === 'staff') return 'director';
    if (role === 'leadership') return 'executive';
    return 'employee';
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        navigate('/questions/1', { state: { role: backendRole } });
      } else {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter your organization or NGO name"
                  />
